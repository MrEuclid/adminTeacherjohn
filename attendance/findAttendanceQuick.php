...
<head>
    ...
    <style>
        ...
        #month {background-color: blue; text-align: center; color: white;}
        body {
...
<body class="p-4 md:p-8">
    ...
    <script>
        ...
        // This ensures the sort function treats them as dates, not numbers or strings.
        const DATE_KEYS = ['date', 'birth_date', 'created_at', 'Date']; 
        ...
        async function fetchData() {
            ...
            try {
                ...
                const response = await fetch('allPIOAttendanceQueryNew.php');
